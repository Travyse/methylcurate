...
If you find a security vulnerability in methylcurate, please report it through [GitHub's private vulnerability reporting](https://github.com/travyse/methylcurate/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact travyse.edwards@pennmedicine.upenn.edu for details.
