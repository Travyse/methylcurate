...
const dispatcher = new Agent({
  // Time (ms) allowed between *chunks* arriving from upstream.
  // If your upstream can be silent for minutes, disable:
  bodyTimeout: 0,

  // Time (ms) to receive response headers; also can bite long-held connections:
  headersTimeout: 0,
});
